    ...
    <div class="sales-board">
      <div  v-for="(article,index) in articleList" class="sales-board-intro" @click="toArticleDetail(article)">
        ...
        <div class="btn-area">
          ...
          <button class="del-btn Button ContentItem-more Button--plain" type="button" @click.stop="deleteArticle(index,article)">删除</button>
          <button class="Button ContentItem-more Button--plain" type="button" @click.stop="readArticle(index,article)">查看</button>
          <button class="Button ContentItem-more Button--plain" type="button" @click.stop="editArticle(index,article)">编辑</button>
        </div>
        </div>
    </div>
</template>
...
<script>
  export default {
    ...
    methods:{
      ...
      readArticle(index,article){
        this.$router.push({ path: `/article/${article.id}` })
      },
      editArticle(index,article){
        this.$router.push({ path: `article/edit/${article.id}`});
      },
